...
Source Server         : lokalxampp177
Source Server Version : 50516
Source Host           : localhost:3306
Source Database       : db_toko_susu_padma

Target Server Type    : MYSQL
Target Server Version : 50516
File Encoding         : 65001

Date: 2016-12-05 20:09:00
*/
...
INSERT INTO `pos_karyawan` VALUES ('37', 'lili', 'lili', 'lala', 'lili', 'lili\r\n', '2', '0', null, null, null, null);
INSERT INTO `pos_karyawan` VALUES ('38', 'pengawas', 'aal', 'aal', 'mandor', '-', '2', '0', null, null, null, null);
...
-- ----------------------------
-- Table structure for `trans_jual_detail_pemby`
-- ----------------------------
DROP TABLE IF EXISTS `trans_jual_detail_pemby`;
CREATE TABLE `trans_jual_detail_pemby` (
  `no_nota` varchar(255) NOT NULL DEFAULT '',
  `tot_blm_pot` decimal(15,0) DEFAULT NULL,
  `nom_pot_tot` decimal(15,0) DEFAULT NULL,
  `nom_total` decimal(15,0) DEFAULT NULL,
  `nom_tunai` decimal(15,0) DEFAULT NULL,
  `kembalian` decimal(15,0) DEFAULT NULL,
  `nom_debit` decimal(15,0) DEFAULT NULL,
  `ket_debit` varchar(50) DEFAULT NULL,
  `nom_kredit` decimal(15,0) DEFAULT NULL,
  `ket_kredit` varchar(50) DEFAULT NULL,
  `nom_piutang` decimal(15,0) DEFAULT NULL,
  `metod_bayar` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`no_nota`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of trans_jual_detail_pemby
-- ----------------------------
