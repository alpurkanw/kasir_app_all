...
Source Database       : lm1_new

Target Server Type    : MYSQL
Target Server Version : 50505
File Encoding         : 65001

Date: 2019-02-26 21:11:45
*/
...
CREATE TABLE `pos_barang` (
  ...
  `jum_stok` decimal(10,1) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `pos_karyawan` VALUES ('1', 'Bayu Wilyan Dinata', 'bayu', 'b', '085311957208', '-', '1', '0', '', '', '', '');
...
INSERT INTO `pos_karyawan` VALUES ('5', 'joko waluyo', 'joko', 'joko', '085769124139', '', '4', '0', '', '', '', '');
...
-- ----------------------------
-- Table structure for `pos_setoran`
-- ----------------------------
DROP TABLE IF EXISTS `pos_setoran`;
CREATE TABLE `pos_setoran` (
  `id` int(8) NOT NULL AUTO_INCREMENT,
  `tgl_inp` varchar(8) DEFAULT NULL,
  `jam` varchar(8) DEFAULT NULL,
  `user_in` varchar(25) DEFAULT NULL,
  `nom_setor` decimal(15,0) DEFAULT NULL,
  `st_up` int(1) DEFAULT NULL,
  `tgl_up` decimal(8,0) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of pos_setoran
-- ----------------------------
...
CREATE TABLE `pos_trans_koreksi_jum_bar` (
  ...
  `jum_awal` decimal(10,1) DEFAULT NULL,
  `jum_koreksi` decimal(10,1) DEFAULT NULL,
  `jum_akhir` decimal(10,1) DEFAULT NULL,
...
CREATE TABLE `trans_beli` (
  ...
  `harga_jual` decimal(15,0) DEFAULT NULL,
  `harga_beli` decimal(15,0) DEFAULT NULL,
  `jum_beli` decimal(10,1) DEFAULT NULL,
  `jum_harga` decimal(15,0) DEFAULT NULL,
  `subtotal` decimal(15,0) DEFAULT NULL,
  `tot_berat` decimal(10,3) DEFAULT NULL,
...
CREATE TABLE `trans_jual` (
  ...
  `harga_jual` decimal(15,0) DEFAULT NULL,
  `tot_berat` decimal(10,3) DEFAULT NULL,
  `jum_bar` decimal(10,1) DEFAULT NULL,
